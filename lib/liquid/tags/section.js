...
(function() {
  ...
  module.exports = Section = (function(superClass) {
    ...
    SyntaxHelp = "Syntax Error in 'section' - Valid syntax: section [sectionName]";

    function Section(template, tagName, markup, tokens) {
      var match;
    ...
    Section.prototype.render = function(context) {
      ...
      return fileVariable.render(context).then(function(actualfile) {
        return templ.engine.fileSystem.readSectionFile(actualfile);
      }).then(function(src) {
